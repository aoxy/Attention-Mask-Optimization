...
int main() {
    ...
    float x_host[36] = {-1.2826, -0.6806, -2.2560, -1.3413, 0.2817, 0.5038,  -1.8254, -1.9429, 0.7377,  0.3440, 0.1802,  0.6127,
                        1.6980,  0.5556,  -1.1677, -0.1341, 0.7508, 1.0985,  1.2927,  0.4277,  0.0090,  0.2681, -0.8233, -1.0023,
                        -0.5383, -1.9241, -0.5544, 0.3266,  1.3766, -0.0398, 3.1833,  0.1095,  -0.0926, 0.6948, 3.0552,  -0.2683};
    float* x_device;
