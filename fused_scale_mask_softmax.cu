...
int main() {
    ...
    float x_host[N] = {-1.5750, 0.8208,  1.0912,  0.9168,  -1.5320, -0.2684, 0.3818,  0.8193,  -0.8741, -0.4795, -0.3150, 0.6600,  0.8998,  -1.0443,
                       -1.0339, 1.9033,  -0.1220, -0.0996, -1.0208, 0.1824,  -0.0534, 1.0790,  0.2189,  -1.5417, 2.7176,  -0.2942, 0.8206,  0.4761,
                       0.5153,  2.2493,  1.3122,  0.5385,  0.9703,  -0.1732, 0.2904,  -0.3161, -0.0914, -1.4529, -0.3745, 0.1957,  1.0984,  -1.5152,
                       -0.7857, -1.3771, -0.2118, 0.0803,  -0.8644, 1.1325,  -0.0163, 2.0358,  0.6570,  0.4646,  -0.5524, -1.0282, -0.4806, 2.4312,
                       0.2629,  -0.9053, -0.1270, -0.2771, -0.9992, -1.6758, -0.8033, -0.1427, -1.4253, -0.0271, 0.2707,  0.1804,  -1.4612, -0.6113,
                       -0.1468, -0.2645, -1.8278, -0.6693, -0.3913, 2.1776,  0.3974,  -0.2431, 1.0991,  -0.5132, -1.6412, 0.0449,  0.1421,  1.4401,
                       0.5555,  0.2622,  0.1500,  1.7765,  1.4523,  -0.8186, -0.7799, -0.8366, -0.1318, 0.7202,  0.1186,  0.7559,  1.0590,  0.9259,
                       0.5443,  -0.6451, -0.0184, 0.8693,  0.2076,  -0.1985, 0.1889,  -0.9082, 0.9096,  -0.5462, -1.5394, 0.2451,  2.0656,  0.8373,
                       1.5837,  -0.3583, 0.7498,  0.4501,  0.4259,  -1.0305, 1.0800,  1.3694,  -0.6132, 1.4491,  -1.3477, -0.2510, -0.4184, 0.3531,
                       -0.5006, 1.6885,  0.4269,  0.1267,  0.0161,  -0.1127, -0.1446, 0.9005,  -3.0782, -0.0523, 0.0391,  -0.8658, 1.1948,  -0.6101,
                       -0.7127, 0.5491,  0.1219,  -1.6231, -0.0590, 0.1783,  -0.7735, 0.6244,  -0.4239, 0.1219};
    float* x_device;
    cudaMalloc((void**)&x_device, N * sizeof(float));
    // std::cout << "sizeof(x_host) = " << sizeof(x_host) << std::endl;
    ...
    // std::cout << "simplified_num_dims = " << simplified_num_dims << std::endl;
